...
const ClientWorld = ({ data, globeConfig }: { data: any; globeConfig: any }) => {
  return (
    <div className="w-full h-full bg-gradient-to-br from-blue-900 to-purple-900 rounded-lg flex items-center justify-center">
      <div className="text-center text-white">
        ...
        <p className="text-sm opacity-80">3D visualization coming soon</p>
      </div>
    </div>
  );
};
      ...
      <div className="flex flex-col  md:flex-row items-center md:items-start h-full md:h-[30rem] ">
        ...
        >
          ...
          <div className="flex justify-center md:justify-start mt-4">
            <Link href="https://github.com/Debanjannnn/google_solution" className="group">
              <div className="p-[3px] relative cursor-pointer">
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center relative">
          <div className="w-full md:w-[30rem] h-[20rem] md:h-[30rem] relative z-10">
            <ClientWorld data={sampleArcs} globeConfig={globeConfig} />
          </div>
        </div>
      </div>
    </div>
